...
class CommissionsControllerTest < ActionController::TestCase
  ...
  test "should create commission" do
    assert_difference('Commission.count') do
      post :create, commission: { commission_amount: @commission.commission_amount, commission_rate: @commission.commission_rate, load_amount: @commission.load_amount }
    end
  ...
  test "should update commission" do
    patch :update, id: @commission, commission: { commission_amount: @commission.commission_amount, commission_rate: @commission.commission_rate, load_amount: @commission.load_amount }
    assert_redirected_to commission_path(assigns(:commission))
  end
