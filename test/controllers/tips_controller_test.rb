...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { commission_amount: @tip.commission_amount, commission_rate: @tip.commission_rate, load_amount: @tip.load_amount, user_id: @tip.user_id }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { commission_amount: @tip.commission_amount, commission_rate: @tip.commission_rate, load_amount: @tip.load_amount, user_id: @tip.user_id }
    assert_redirected_to tip_path(assigns(:tip))
  end
